/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: ceaad4ca4ef5504b8dd07b8bbc350e41)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "https://field-hours.vercel.app,http://localhost:5173,http://127.0.0.1:5173";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SESSION_TTL_SECONDS" | "INVITE_TTL_SECONDS" | "ENVIRONMENT">> {}
}
