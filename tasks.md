...
- **Mantenimiento actual**: Tarea O.11 — matriz crítica multinavegador (COMPLETADA Y ACTIVA EN CI). Próxima prioridad operativa: cerrar la validación productiva de Google OAuth.
