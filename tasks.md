...
- [x] **Tarea O.13 (Alertas y recuperación D1) — APROBADA, PENDIENTE DE PUSH**: Monitor HTTP programado/manual con reintentos, incidencia GitHub deduplicada y autocierre; ensayo reproducible que restaura un export D1 sintético en una segunda D1 local aislada. Evidencia: monitor unitario 2/2, D1 con 50 objetos/13 contadores idénticos y cero violaciones FK, contratos productivos de solo lectura 5/5, bookmark Time Travel vigente, YAML válido y Worker dry-run. Después de `npm ci`, el gate completo aprobó typechecks, lint, build, SheetJS, Worker 6/6, operaciones, Playwright 16/16 y audit con 0 vulnerabilidades. Runbook: `docs/OPERATIONS.md`; release/rollback: `docs/RELEASE-2026-08-28-operations.md`.
...
- **Mantenimiento actual**: Tarea O.13 — alertas y práctica controlada de recuperación D1 (APROBADA, PENDIENTE DE PUSH). O.14 registra el endurecimiento pendiente del pepper de contraseñas.
