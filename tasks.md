...
- [ ] Calcular automáticamente el primer día de cada mes: horas aprobadas, salario bruto, seguro social del trabajador, ITIS/impuestos, deducciones, salario neto y totales acumulados. Implementación local en revisión: preview admin protegido con reglas Jersey 2026 y advertencia de estimación; pendiente despliegue y validación operativa.
