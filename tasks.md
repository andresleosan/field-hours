...
- [ ] Permitir que el administrador configure tarifa por hora, periodo de pago, datos del negocio y reglas fiscales de Jersey antes de calcular la nómina. Implementación local en revisión: migración D1 0007, endpoint admin+CSRF y formulario responsive; pendiente backup, aplicación en producción y despliegue.
